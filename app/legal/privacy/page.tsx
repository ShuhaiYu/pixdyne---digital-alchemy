    ...
    <div className="min-h-screen bg-white text-black p-8 md:p-24">
      ...
      <div className="max-w-3xl">
        ...
        <div className="prose prose-lg">
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">1. Information We Collect</h2>
          ...
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">2. How We Use Your Information</h2>
          <p className="mb-8 text-gray-700">
          ...
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">3. Cookies and Tracking</h2>
          <p className="mb-8 text-gray-700">
          ...
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">4. Data Security</h2>
          <p className="mb-8 text-gray-700">
          ...
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">5. Your Rights</h2>
          <p className="mb-8 text-gray-700">
          ...
          <h2 className="font-bold uppercase tracking-widest text-sm mb-4">6. Contact Us</h2>
          <p className="mb-8 text-gray-700">
        ...
        <div className="mt-12 pt-8 border-t border-black/10">
          <Link href="/legal/terms" className="text-sm font-mono text-brand-yellow hover:text-black transition-colors">

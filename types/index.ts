...
export interface BlogPost {
  ...
  content?: string;
  /**
   * Short, punchy lines rendered as on-brand pull-quote images inside the
   * article body (generated by /api/blog-image). Each entry maps to one inline
   * `<figure>` in `content` via its index (e.g. ?slug=…&i=0).
   */
  pullQuotes?: string[];
  seoTitle?: string;
  seoDescription?: string;
